...
from model import scot_CAM_loss_entropy, util
import evaluate_map_CAM_loss_entropy
...
def beamsearch_hp(datapath, benchmark, backbone, thres, alpha, logpath,
    ...
    model = scot_CAM_loss_entropy.SCOT_CAM(backbone, '0', benchmark, device,
    ...
    for base in candidate_base:
        ...
        score = evaluate_map_CAM_loss_entropy.run(datapath, benchmark, backbone, thres, alpha,
