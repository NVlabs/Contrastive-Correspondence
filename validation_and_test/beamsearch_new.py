...
def beamsearch_hp(datapath, benchmark, backbone, thres, alpha, logpath,
    ...
    model = scot_CAM.SCOT_CAM(backbone, '0', benchmark, device, args.cam, args.num_classes, args.modelpath)
    ...
    for base in candidate_base:
        ...
        score = evaluate_map_CAM_new.run(datapath, benchmark, backbone, thres, alpha,
